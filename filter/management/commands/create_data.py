...
from filter.models import Journal, Author, Category


categories = ['Sport', 'Lifestyle', 'Music', 'Coding', 'Travelling']

authors = ['John', 'Micheal', 'Luke', 'Sally', 'Joe', 'Dude', 'Guy', 'Barbara']
...
class Command(BaseCommand):
    def add_arguments(self, parser):
        parser.add_argument('file_name', type=str, help='The txt file that contains journal titles.')
